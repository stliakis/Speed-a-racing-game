...
public class Shapes {
	public static class Shape{
		...
		public static void registerShape(String name,float[] vertices,short[] indices){
			shapes.put(name, new Shape(vertices,indices));
		}
		public static void registerShape(String name,double[] vertices,short[] indices){
			float[] vers=new float[vertices.length];
			for(int c=0;c<vertices.length;c++){
				vers[c]=(float) vertices[c];
			}
			shapes.put(name, new Shape(vers,indices));
		}
	...
	private static Shape cube,cubeTextured;
	public static Shape cube () {
		...
		cube=new Shape(vertices,indices);
		return cube;
	}
	public static Shape cubeTextured () {
		if(cubeTextured!=null)return cubeTextured;
		float[] cubeVerts = {-0.5f, -0.5f, -0.5f, -0.5f, -0.5f, 0.5f, 0.5f, -0.5f, 0.5f, 0.5f, -0.5f, -0.5f, -0.5f, 0.5f, -0.5f,
			-0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, -0.5f, -0.5f, -0.5f, -0.5f, -0.5f, 0.5f, -0.5f, 0.5f, 0.5f, -0.5f,
			0.5f, -0.5f, -0.5f, -0.5f, -0.5f, 0.5f, -0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, -0.5f, 0.5f, -0.5f, -0.5f, -0.5f,
			-0.5f, -0.5f, 0.5f, -0.5f, 0.5f, 0.5f, -0.5f, 0.5f, -0.5f, 0.5f, -0.5f, -0.5f, 0.5f, -0.5f, 0.5f, 0.5f, 0.5f, 0.5f,
		...
		cubeTextured=new Shape(vertices,indices);
		return cubeTextured;
	}

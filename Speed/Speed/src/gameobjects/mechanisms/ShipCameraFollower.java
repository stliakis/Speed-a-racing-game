...
public class ShipCameraFollower extends WorldMechanism {
	public boolean reachedCamera=false;
	...
	public void init() {
		super.init();
		reachedCamera=false;
		entity.pos.set( -entity.world.cameraPos.x, -entity.world.cameraPos.y-10, 0.25f);
	}
	@Override
	public void update() {
		super.update();
		...
		}else entity.vel.y+=(1-entity.vel.y)/100;
		...
		if(reachedCamera){
			...
			entity.world.cameraPos.y+=((-(entity.pos.y-1.5f)-entity.world.cameraPos.y))*Gdx.graphics.getDeltaTime()*8;
		}

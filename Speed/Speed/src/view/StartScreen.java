...
public class StartScreen  extends Screen{
	...
	public StartScreen(final MenuBackground background){
		...
		FontParrameters font=new FontParrameters("menu", x(0.02f), 1, 1, 1);
		
		final Button btnBegin=new Button(x(50),y(50),x(30),x(8),"START",font,"ui/button1.png",this);
		btnBegin.setOnEventListener(new OnEventListener(Keys.ENTER,Keys.SPACE) {
	    	@Override
	    	public void onEventEnd(Input input, Object caller) {
	    		super.onEventEnd(input, caller);
	    		getDirector();
	    		Director.effect.start(getDirector(),GameScreen.class,0.05f);
		...
		getUirenderer().addItem(btnBegin,btnExit,btnAbout);
	}
	@Override
	public void Render() {
		background.render();

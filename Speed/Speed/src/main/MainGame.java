...
public class MainGame extends Director {
	...
	public void create() {
		...
		loadAsset(Texture.class, 
				...
				"sprites/burner.png",
				"sprites/glare.png",
				"sprites/raindrop.png"
		);
		
		loadAsset(Music.class, 
				"music/Junkie XL - Mushroom [HD].mp3"
		);
		
		loadAsset(Sound.class, 
				"sounds/button.wav",
				"sounds/star.wav",
				"sounds/gameover.mp3",
				"sounds/engine.wav",
	...
	public void onAssetsLoaded() {
		...
		addScreen(game,
				new Credits(menuBackground),
				new StartScreen(menuBackground),
				new PauseScreen(menuBackground),
				new GameOverScreen(menuBackground)
		);
		...
		if(MainGame.config.SOUND_VOL==1)MusicPlayer.setVolume(1);
		else MusicPlayer.setVolume(0);
	...
	public void pause() {
		...
		super.pause();
		paused=true;
		if(getScreen(GameScreen.class)!=null)getScreen(GameScreen.class).world.running=false;
	}
	@Override
	public void resume() {
		// TODO Auto-generated method stub
		super.resume();
		paused=false;
		if(getScreen(GameScreen.class)!=null)getScreen(GameScreen.class).world.running=true;
	}
}
